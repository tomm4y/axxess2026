...
const HealthSafeLogin: React.FC = () => {
  ...
  const handleLoginEnter = (e: MouseEvent<HTMLButtonElement>): void => {
    e.currentTarget.style.transform = "scale(1.02)";
    e.currentTarget.style.boxShadow = "0 12px 32px rgba(233,30,140,0.45)";
  };

  const handleLoginLeave = (e: MouseEvent<HTMLButtonElement>): void => {
    e.currentTarget.style.transform = "scale(1)";
    e.currentTarget.style.boxShadow = "0 8px 24px rgba(233,30,140,0.35)";
  };

  const handleForgotEnter = (e: MouseEvent<HTMLButtonElement>): void => {
    e.currentTarget.style.opacity = "0.7";
  };

  const handleForgotLeave = (e: MouseEvent<HTMLButtonElement>): void => {
    ...
    >
      ...
      <div>
        ...
        >
          ...
          >
            <button
              onMouseEnter={handleForgotEnter}
          ...
          >
            {[
              ...
              <button
                ...
                onMouseLeave={(e) => {
                  e.currentTarget.style.borderColor = "#f0d0e8";
